...
async def get_number(site, code):
    base_urls = {
        ...
        "smsbower": f"https://smsbower.online/stubs/handler_api.php?api_key={API_KEY_SMSBOWER}&action=getNumber&service={SERVICE}&country={code}&maxPrice=0.7400&phoneException=7700,7708",
