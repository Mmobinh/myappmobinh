...
async def get_number_smb(code):
    url = f"https://smsbower.online/stubs/handler_api.php?api_key={API_KEY_SMSBOWER}&action=getNumber&service={SERVICE}&country={code}&maxPrice=0.7400&providerIds=2196,2194,2195&exceptProviderIds=1000&phoneException=7700,7708"
